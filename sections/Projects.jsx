  ...
  return (
    <section id="projects">
      ...
      >
        ...
        <ProjectItem name={"The Coders Adda"} img={'/p2.png'} code={"https://github.com/shreyashsingh-101/Hack-Nagpur"} live={""} description={"One Stop Destination for all developers to get resources, team and productivity manager."} />
